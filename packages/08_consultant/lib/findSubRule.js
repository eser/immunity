...
var getRuleChildren_1 = require("./getRuleChildren");
function findSubRule(node, predicate) {
    return __awaiter(this, void 0, void 0, function () {
        var children, _a, _b, _i, childKey, child, result;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0: return [4, getRuleChildren_1.default(node)];
                case 1:
                    children = _c.sent();
                ...
                case 2:
                    ...
                    return [4, findSubRule(child, predicate)];
                case 3:
                    result = _c.sent();
                    if (result !== undefined) {
                        return [2, result];
