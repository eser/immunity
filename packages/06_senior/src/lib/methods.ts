...
interface SeniorMethods {
    ...
    list(options?: Options): { [key: string]: string };
    listModuleIndexes(options?: Options): { [key: string]: string };
    load(moduleName: string, globals: { [key: string]: any }, options?: Options): any;
    loadAll(globals: { [key: string]: any }, options?: Options): { [key: string]: any };
}
