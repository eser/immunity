...
exports.defaultSeverities = defaultSeverities;
class LogManager {
    constructor(events) {
        this.events = events;
        this.loggerTypes = {
            'console': ConsoleLogger_1.default,
            'stream': StreamLogger_1.default,
        };
        this.formatters = {
            'basic': new BasicFormatter_1.default(),
            'nodeConsole': new NodeConsoleFormatter_1.default(),
        };
