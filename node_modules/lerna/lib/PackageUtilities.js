...
var PackageUtilities = function () {
  ...
  _createClass(PackageUtilities, null, [{
    ...
    */
    ...
    key: "symlinkPackages",
    value: function symlinkPackages(packages, packageGraph, logger, callback) {
      ...
      var actions = packages.map(function (iteratedPackage) {
        var filteredDependencyNames = Object.keys(iteratedPackage.allDependencies).filter(function (dependency) {
          ...
          return match && _FileSystemUtilities2.default.existsSync(_path2.default.join(match.package.location, "package.json")) && iteratedPackage.hasMatchingDependency(match.package);
        });
